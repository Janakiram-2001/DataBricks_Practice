...
@dp.table(
    name="logistics_dp.logistics_schema.silver_staff_dlt3",
...
def silver_staff_dlt3():
    df1 = spark.readStream.table("logistics_dp.logistics_schema.bronze_staff_data1")
    df2 = spark.readStream.table("logistics_dp.logistics_schema.bronze_staff_data2")
    uniondf = df1.unionByName(df2,allowMissingColumns=True)
    return (uniondf.select(
...
@dp.table(
    name="logistics_dp.logistics_schema.silver_geotag_dlt3",
...
def silver_geotag_dlt2():
    return (
        spark.readStream.table("logistics_dp.logistics_schema.bronze_geotag_data1")
        .select(
...
@dp.table(
    name="logistics_dp.logistics_schema.silver_shipments_dlt3",
...
def silver_shipments_dlt2():
    ...
    return (
        spark.readStream.table("logistics_dp.logistics_schema.bronze_shipments_data1")
