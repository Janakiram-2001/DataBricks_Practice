...
return_status=dbutils.notebook.run("/Workspace/Git Folder/DataBricks_Practice/(Clone) databricks_workouts_2025_WE47/1_DATABRICKS_NOTEBOOK_FUNDAMENTALS/4_child_notebook",90,{"table_name":"details"})
